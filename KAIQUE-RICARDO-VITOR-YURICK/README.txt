...
No exemplo programa fatorial disponibilizada, foi necessário realizar algumas mudanças de maneira que o fatorial de n fosse calculado, pois da maneira indicada a ser implementado os algoritmos, o cálculo feito era de fatorial (n-1). Assim, as intruções adicionadas tiveram como objetivo realizar a multiplicação do último elemento da pilha de dados, pois a recursão era feita até (n-1).